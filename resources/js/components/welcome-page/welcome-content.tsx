      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <button className="bg-chess-green text-white p-4 rounded-lg hover:bg-green-600 bg-green-400 transition">
                  ...
                  <p className="text-sm">Match with a player of your level</p>
                </button>
                <button className="bg-chess-blue text-white p-4 rounded-lg hover:bg-blue-800 bg-blue-500 transition">
                  ...
                  <p className="text-sm">Practice against AI</p>
                </button>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-4">
              <h2 className="text-xl font-bold mb-4">Chess News</h2>
              <ul className="space-y-3">
                <li className="border-b pb-2">
                  <a href="#" className="hover:text-chess-blue">Carlsen wins another tournament</a>
                </li>
                <li className="border-b pb-2">
                  <a href="#" className="hover:text-chess-blue">New opening trends in 2023</a>
                </li>
                <li>
                  <a href="#" className="hover:text-chess-blue">How to improve your endgame</a>
                </li>
              </ul>
            </div>
          </div>
